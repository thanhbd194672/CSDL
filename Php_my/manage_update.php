...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>Cập nhật thông tin</title>
      ...
      <link href="manage_update.css" rel="stylesheet" type="text/css" />
      <script type="text/javascript" src="js/cufon-yui.js"></script>
      <script type="text/javascript" src="js/arial.js"></script>
      <script type="text/javascript" src="js/cuf_run.js"></script>
      <link href="manage_update.css?t=[timestamp]" type="text/css" rel="stylesheet">
  </head>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="manage.php">Quản lí thông tin covid 
          <small>Phường Hai Bà Trưng </small></a></h1>
      </div>
      <br/>
      <div class="menu_nav">
        <ul>
          <li><a href="test_covid_form.php">Test covid</a></li>
          <li><a href="cured_person_form.php">Người bệnh</a></li>
          <li><a href="dead_person_form.php">Khai tử</a></li>
