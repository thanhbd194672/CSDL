            ...
            <form class="mb-5" method="post" id="contactForm" name="contactForm">
              <div class="row">
                ...
                <div class="col-md-6 form-group mb-5">
                  ...
                  <input type="boolean" class="form-control" name="Test_result" id="Test_result"  placeholder="Kết quả">
                </div>
              </div>

              <div class="row">
                <div class="col-md-6 form-group mb-5">
                  <label for="" class="col-form-label">Thời gian test</label>
                  <input type="date" class="form-control" name="Time_test" id="Time_test"  placeholder="Thời gian test">
                </div>
                <div class="col-md-6 form-group mb-5">
                  <label for="" class="col-form-label">Địa điểm test</label>
                  <input type="text" class="form-control" name="Test_location" id="Test_location"  placeholder="Địa điểm test">
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 form-group mb-5">
                  <label for="" class="col-form-label">Phương thức test</label>
                  <input type="text" class="form-control" name="Method_test" id="Method_test"  placeholder="Phương thức test">
                </div>
              </div>
