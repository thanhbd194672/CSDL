...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>Trang chủ</title>
      ...
      <link href="khaibaogan.css" rel="stylesheet" type="text/css" />
      <script type="text/javascript" src="js/cufon-yui.js"></script>
      <script type="text/javascript" src="js/arial.js"></script>
      <script type="text/javascript" src="js/cuf_run.js"></script>
      <link href="khaibaogan.css?t=[timestamp]" type="text/css" rel="stylesheet">
  </head>
          ...
          if(!$con){
            echo "Error\n";
             ...
             $query = "SELECT U1.name_person, U1.telephone_number,H1.possible_covid,H1.time_declaration 
              ...
              HAVING H1.id_person = H2.id_person));  ";
