...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>Trang cá nhân </title>
      ...
      <link href="users.css?t=[timestamp]" type="text/css" rel="stylesheet">
    <?php
		session_start();
	?>
      <?php
      ...
      if(!$con){
        echo "Error\n";
           	...
           	$query = "SELECT  * FROM users WHERE id_person = $id_key;";
    ...
    <script type="text/javascript">
        ...
        var kq24= <?php echo json_encode($kq->name_person)?> ;
    	var kq25 = <?php echo json_encode($kq->national_id_number)?>;
        var kq26 = <?php echo json_encode($kq->health_insurance)?> ;
        var kq27 = <?php echo json_encode($kq->date_of_birth)?>;
        var kq28 = <?php echo json_encode($kq->nationality)?> ;
        var kq29 = <?php echo json_encode($kq->telephone_number)?>;
        var kq30 = <?php echo json_encode($kq->gender)?>;
        ...
        var kq23= Number(<?php echo json_encode($kq_death_all->count)?>);
         var kq31= Number(<?php echo json_encode($kq_vaccine->count)?>);
        var kq32= Number(<?php echo json_encode($kq_not_vaccine->count)?>);
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="clr"></div>
      <div class="htext">
        <h2>Xin chào bạn  <script>document.write(kq24)</script></h2>
  ...
  <div id = "chart_title"> 
    ...
    <div class="feature-layout">
            <div class="feature-item1">
                ...
                <p id ="a"> <script type="text/javascript">document.write(kq31)</script>
                người</p>
            </div>
            <div class="feature-item1">
                <h2>Số người chưa được tiêm</h2>
                <p id ="a"> <script type="text/javascript">document.write(kq32)</script>
                người</p>
            </div>
        </div>
